...
if (!isMobile()) {
  document.addEventListener("DOMContentLoaded", function (event) {
    ...
    var aElem = document.getElementById('parallax');
...
var clearButton = document.querySelector('#parallax');
function clear() {
...
function scrlResize() {
  ...
  var playground = $('#playground').offset().top;
...
var slider = document.querySelector('.projects');
var isDown = false;
...
var swalButton = document.getElementById('confirm');
...
$(".scroll-next").click(function () {
  var scrollSection = $(this).closest(".scrollable-section").next().offset().top;
